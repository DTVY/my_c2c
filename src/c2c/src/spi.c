 ...
 * Master (Output)            Slaver (Input, EXTI)
 *          PA1      ------>       PA0
 *
 */
...
/**
 * @brief         Request In GPIO pin configuration
 * @param[in]     None
 * @param[in,out] None
 * @return        void
 */
...
/**
 * @brief         Request Out GPIO pin configuration
 * @param[in]     None
 * @param[in,out] None
 * @return        void
 */
...
/**
 * @brief         SPI RX stream DMA completed interrupt handler
 * @param[in]     None
 * @param[out]    None
 * @return        void
 */
...
/**
 * @brief         SPI TX stream DMA completed interrupt handler (not used)
 * @param[in]     None
 * @param[out]    None
 * @return        void
 */
...
extern void C2C_ReceiveFrameRequest(void);


/**
 * @brief         Request in interrupt handler, action is performed after
 *                falling edge of request input signal.
 * @param[in]     None
 * @param[out]    None
 * @return        void
 */
